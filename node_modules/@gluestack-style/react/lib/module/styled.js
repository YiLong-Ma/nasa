...
export function verboseStyled(Component, theme) {
  ...
  function injectSx(sx) {
    ...
    injectComponentAndDescendantStyles(orderedSXResolved, sxHash, type, GluestackStyleSheet, Platform.OS);
  ...
  const StyledComponent = (_ref, ref) => {
    ...
    if (!styleHashCreated) {
      ...
      if (EXTENDED_THEME) {
        ...
        if (Object.keys((EXTENDED_THEME === null || EXTENDED_THEME === void 0 ? void 0 : EXTENDED_THEME.BUILD_TIME_PARAMS) ?? {}).length > 0) {
          ...
          GluestackStyleSheet.inject(EXTENDED_THEME_BUILD_TIME_PARAMS === null || EXTENDED_THEME_BUILD_TIME_PARAMS === void 0 ? void 0 : EXTENDED_THEME_BUILD_TIME_PARAMS.toBeInjected);
        } else {
    ...
    if (AsComp) {
      ...
      if (Component.isStyledComponent) {
        component = /*#__PURE__*/React.createElement(Component, _extends({}, resolvedStyleProps, {
