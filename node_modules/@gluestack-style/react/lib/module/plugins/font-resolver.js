...
export class FontResolver {
    ...
    for (const styledObjectKey in styledObject) {
      if (typeof styledObject[styledObjectKey] === 'object') {
        ...
        if (styledObjectKey === 'fontFamily') {
          setObjectKeyValue(this.#fontFamily, [...keyPath, styledObjectKey], styledObject[styledObjectKey]);
  ...
  componentMiddleWare(_ref) {
    ...
    this.#fontFamily = {};
    const Comp = /*#__PURE__*/React.forwardRef((props, ref) => {
      ...
      const {
        variantProps,
        restProps
      } = getVariantProps(props, styledConfig, false);
      const variantStyledObject = resolveVariantFontsConfig(variantProps, styledConfig);
      let componentStyledObject = deepMergeObjects(styledConfig, variantStyledObject);
      ...
      const resolvedSxProps = this.inputMiddleWare(sxPropsWithThemeProps, false);
