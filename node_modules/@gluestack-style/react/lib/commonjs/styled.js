...
function verboseStyled(Component, theme) {
  var _componentStyleConfig, _Component;
  ...
  function injectSx(sx) {
    ...
    (0, _injectComponentAndDescendantStyles.injectComponentAndDescendantStyles)(orderedSXResolved, sxHash, type, _styleSheet.GluestackStyleSheet, _reactNative.Platform.OS);
  ...
  const StyledComponent = (_ref, ref) => {
    ...
    const COLOR_MODE = (0, _colorMode.get)();
    if (!styleHashCreated) {
      ...
      if (EXTENDED_THEME) {
        ...
        if (Object.keys((EXTENDED_THEME === null || EXTENDED_THEME === void 0 ? void 0 : EXTENDED_THEME.BUILD_TIME_PARAMS) ?? {}).length > 0) {
          ...
          _styleSheet.GluestackStyleSheet.inject(EXTENDED_THEME_BUILD_TIME_PARAMS === null || EXTENDED_THEME_BUILD_TIME_PARAMS === void 0 ? void 0 : EXTENDED_THEME_BUILD_TIME_PARAMS.toBeInjected);
        } else {
          ...
          _styleSheet.GluestackStyleSheet.inject(extendedStylesToBeInjected);
        }
      }
      if (CONFIG.plugins) {
      ...
      if (plugins) {
        for (const pluginName in plugins) {
          ...
          // @ts-ignore
          [theme,,, Component] = (_plugins$pluginName = plugins[pluginName]) === null || _plugins$pluginName === void 0 ? void 0 : _plugins$pluginName.inputMiddleWare(theme, true, true, Component);
        }
      }
      ...
      if (!BUILD_TIME_PARAMS || !(BUILD_TIME_PARAMS !== null && BUILD_TIME_PARAMS !== void 0 && BUILD_TIME_PARAMS.orderedResolved) || (BUILD_TIME_PARAMS === null || BUILD_TIME_PARAMS === void 0 ? void 0 : BUILD_TIME_PARAMS.orderedResolved.length) === 0) {
        ...
        if (_reactNative.Platform.OS === 'web') {
          _styleSheet.GluestackStyleSheet.inject(toBeInjected);
        }
      } else {
        if (_reactNative.Platform.OS === 'web') {
          //@ts-ignore
          _styleSheet.GluestackStyleSheet.inject(BUILD_TIME_PARAMS.toBeInjected);
        }
      }
    ...
    if (AsComp) {
      ...
      if (Component.isStyledComponent) {
        component = /*#__PURE__*/_react.default.createElement(Component, _extends({}, resolvedStyleProps, {
  ...
  const displayName = componentStyleConfig !== null && componentStyleConfig !== void 0 && componentStyleConfig.componentName ? componentStyleConfig === null || componentStyleConfig === void 0 ? void 0 : componentStyleConfig.componentName : (_Component = Component) === null || _Component === void 0 ? void 0 : _Component.displayName;
...
function styled(Component, theme, componentStyleConfig, ExtendedConfig, BUILD_TIME_PARAMS) {
  ...
  let StyledComponent = verboseStyled(Component, sxConvertedObject, componentStyleConfig, ExtendedConfig, BUILD_TIME_PARAMS);
