...
export type GlobalVariantAliasesProps<Aliases, Tokens> = RemoveNever<{
    [key in keyof Aliases]?: Aliases[key] extends keyof RNStyledProps ? Aliases[key] extends keyof PropertyTokenType ? PropertyTokenType[Aliases[key]] extends keyof Tokens ? StringifyToken<keyof Tokens[PropertyTokenType[Aliases[key]]]> | ExtendRNStyle<RNStyledProps, Aliases[key]> : never : any : any;
}> | RNStyledProps;
...
export type TokenizedRNStyleProps<GenericComponentStyles> = {
    [key in keyof GenericComponentStyles]?: key extends keyof PropertyTokenType ? PropertyTokenType[key] extends 'sizes' ? StringifyToken<keyof GSConfig['tokens']['space']> | StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[key]]> | ExtendRNStyle<GenericComponentStyles, key> : StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[key]]> | ExtendRNStyle<GenericComponentStyles, key> : GenericComponentStyles[key];
};
