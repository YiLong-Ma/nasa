...
export declare class FontResolver implements IStyledPlugin, FontPlugin {
    ...
    inputMiddleWare(styledObj?: any, shouldUpdate?: boolean): void;
    fontHandler(styledObject: any, shouldUpdate: boolean, fontStyleObject?: any, keyPath?: string[]): any;
    componentMiddleWare({ NewComp, extendedConfig }: any): React.ForwardRefExoticComponent<Omit<any, "ref"> & React.RefAttributes<unknown>>;
}
export {};
